...
from kairos.cli.commands.balance import _render, balance
...
class BalanceCommandTest(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        ub_cls = patch("kairos.user.user_balances.UserBalances").start()
        ...
        self.oracle = SimpleNamespace(
            ...
            quote_token="USD")
        self.oracle_cls = patch("kairos.core.rate_oracle.rate_oracle.RateOracle").start()
