...
from kairos.cli import strategy_configs as sc
...
class StrategyConfigHelpersTest(unittest.TestCase):
    ...
    def test_normalize_pairs_handles_lists_and_non_pair_keys(self):
        from kairos.cli.strategy_configs import _normalize_pairs
    ...
    def test_fill_template_uppercases_trading_pair(self):
        from kairos.cli.strategy_configs import fill_template
    ...
    def test_template_legacy_handles_raising_required_property(self):
        ...
        from kairos.cli.strategy_configs import template_legacy_data
        from kairos.client.config.config_helpers import get_strategy_config_map
    ...
    def test_describe_strategy_controller(self):
        from kairos.cli.strategy_configs import describe_strategy
    ...
    def test_parse_set_pairs(self):
        from kairos.cli.strategy_configs import parse_set_pairs
...
class DescribeStrategyTest(unittest.TestCase):
    ...
    def test_v1_pydantic_config_class(self):
        ...
        with patch("kairos.client.config.config_helpers.get_strategy_pydantic_config_cls",
    ...
    def test_v1_legacy_config_map(self):
        ...
        with patch("kairos.client.config.config_helpers.get_strategy_pydantic_config_cls",
                   return_value=None), \
                patch("kairos.client.config.config_helpers.get_strategy_config_map",
