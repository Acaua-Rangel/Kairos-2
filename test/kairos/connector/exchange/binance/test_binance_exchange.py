...
from kairos.connector.exchange.binance import binance_constants as CONSTANTS, binance_web_utils as web_utils
from kairos.connector.exchange.binance.binance_exchange import BinanceExchange
from kairos.connector.test_support.exchange_connector_test import AbstractExchangeConnectorTests
...
class BinanceExchangeTests(AbstractExchangeConnectorTests.ExchangeConnectorTests):
    ...
    @aioresponses()
    @patch("kairos.connector.time_synchronizer.TimeSynchronizer._current_seconds_counter")
    ...
    @patch("kairos.connector.utils.get_tracking_nonce")
