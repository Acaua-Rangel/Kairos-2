...
import kairos.connector.derivative.binance_perpetual.binance_perpetual_web_utils as web_utils
...
class BinancePerpetualDerivativeUnitTest(IsolatedAsyncioWrapperTestCase):
    ...
    @aioresponses()
    @patch("kairos.connector.derivative.binance_perpetual.binance_perpetual_derivative."
    ...
    @aioresponses()
    @patch("kairos.connector.derivative.binance_perpetual.binance_perpetual_web_utils.get_current_server_time")
