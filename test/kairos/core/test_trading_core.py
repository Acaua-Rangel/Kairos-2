...
from kairos.core.trading_core import StrategyType, TradingCore
from kairos.exceptions import InvalidScriptModule
from kairos.model.trade_fill import TradeFill
from kairos.strategy.strategy_base import StrategyBase
...
class TradingCoreTest(IsolatedAsyncioWrapperTestCase):
    ...
    @patch("kairos.core.trading_core.Clock")
    ...
    def test_detect_strategy_type(self):
        ...
        with patch.object(Path, 'exists') as mock_exists:
            ...
            with patch("kairos.core.trading_core.STRATEGIES", ["pure_market_making"]):
    ...
    @patch("kairos.core.trading_core.MarketsRecorder")
    @patch("kairos.core.trading_core.SQLConnectionManager")
    ...
    @patch("kairos.core.trading_core.RateOracle")
    ...
    async def test_stop_strategy(self):
        ...
        with patch("kairos.core.trading_core.RateOracle") as mock_rate_oracle:
            mock_oracle = Mock()
    ...
    @patch("kairos.core.trading_core.PerformanceMetrics")
    ...
    @patch("kairos.client.config.client_config_map.AnonymizedMetricsEnabledMode.get_collector")
    @patch("kairos.core.trading_core.RateOracle")
    ...
    @patch("kairos.core.trading_core.get_strategy_starter_file")
