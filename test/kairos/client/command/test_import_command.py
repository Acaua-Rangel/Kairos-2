...
from kairos.client.command import import_command
...
from kairos.client.config.config_helpers import ClientConfigAdapter, read_system_configs_from_yml, save_to_yml
...
class ImportCommandTest(IsolatedAsyncioWrapperTestCase):
    ...
    @patch("kairos.client.command.import_command.load_strategy_config_map_from_file")
    @patch("kairos.client.command.status_command.StatusCommand.status_check_all")
    ...
    @patch("kairos.client.config.config_helpers.get_strategy_pydantic_config_cls")
    @patch("kairos.client.command.status_command.StatusCommand.status_check_all")
