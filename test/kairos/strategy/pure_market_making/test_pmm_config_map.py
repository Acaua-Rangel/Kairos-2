...
from kairos.strategy.pure_market_making.pure_market_making_config_map import (
...
class TestPMMConfigMap(unittest.TestCase):
    ...
    def test_validate_price_source_exchange(self):
        ...
        self.assertIsNone(validate_price_source_exchange(value='binance_perpetual_testnet'))
