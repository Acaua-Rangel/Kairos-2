...
from kairos.logger.struct_logger import StructLogger, StructLogRecord

if TYPE_CHECKING:
    from kairos.client.config.config_helpers import ClientConfigAdapter as _ClientConfigAdapter
...
def get_strategy_list() -> List[str]:
    """
    Search `kairos.strategy` folder for all available strategies
