...
def deploy(
    ...
    from kairos.cli.commands.create import create_config
    from kairos.cli.commands.start import launch
    from kairos.cli.strategy_configs import config_path, edit_config, parse_set_pairs, validate_controller
    ...
    if kind == "config":
        ...
        values: dict = {}
        if values_stdin:
            from kairos.cli.commands._common import read_json_object_from_stdin
