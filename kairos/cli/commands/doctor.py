...
from kairos.cli.output import ExitCode, emit, fail, json_option, render_table
...
def _extensions_row() -> dict:
    try:
        import kairos.core.clock  # noqa: F401  (a compiled Cython module)
...
def _loaded_row() -> dict:
    ...
    from kairos.cli.strategy_configs import config_path
