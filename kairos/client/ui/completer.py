...
class KairosCompleter(Completer):
    def __init__(self, kairos_application):
        super(KairosCompleter, self).__init__()
        self.kairos_application = kairos_application
    ...
    def prompt_text(self) -> str:
        return self.kairos_application.app.prompt_text

    @property
    def parser(self) -> ThrowingArgumentParser:
        return self.kairos_application.parser
    ...
    def _exchange_completer(self):
        """Dynamic completer for all connectors"""
    ...
    def _config_completer(self):
        config_keys = self.kairos_application.configurable_keys()
