...
from kairos.client.settings import MAXIMUM_LOG_PANE_LINE_COUNT, MAXIMUM_OUTPUT_PANE_LINE_COUNT
from kairos.client.tab.data_types import CommandTab
from kairos.client.ui.custom_widgets import CustomTextArea as TextArea, FormattedTextLexer
