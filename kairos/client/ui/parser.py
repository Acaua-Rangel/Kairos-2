...
def load_parser(app: "KairosApplication", command_tabs) -> ThrowingArgumentParser:
    ...
    create_parser.set_defaults(func=app.create)
    ...
    import_parser.set_defaults(func=app.import_command)
    ...
    balance_parser.set_defaults(func=app.balance)
    ...
    history_parser.set_defaults(func=app.history)
    ...
    exit_parser.add_argument("-f", "--force", action="store_true", help="Force exit without canceling outstanding orders",
                             default=False)
    exit_parser.set_defaults(func=app.exit)
    ...
    export_parser.set_defaults(func=app.export)
    ...
    ticker_parser.set_defaults(func=app.ticker)
    ...
    mqtt_start_parser.set_defaults(func=app.mqtt_start)
    mqtt_stop_parser = mqtt_subparsers.add_parser("stop", help="Stop the MQTT Bridge")
    mqtt_stop_parser.set_defaults(func=app.mqtt_stop)
    ...
    mqtt_restart_parser.set_defaults(func=app.mqtt_restart)
    ...
    rate_parser.set_defaults(func=app.rate)
