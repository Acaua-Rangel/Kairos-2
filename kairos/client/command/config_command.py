...
from kairos.model.inventory_cost import InventoryCost
from kairos.strategy.pure_market_making import PureMarketMakingStrategy
...
class ConfigCommand:
    def config(self,  # type: KairosApplication
               key: str = None,
               value: str = None):
    ...
    def configurable_keys(self,  # type: KairosApplication
                          ) -> List[str]:
        """
    ...
    async def _config_single_key(self,  # type: KairosApplication
                                 key: str,
                                 input_value):
        """
    ...
    async def _prompt_missing_configs(self,  # type: KairosApplication
                                      config_map):
        missings = missing_required_configs_legacy(config_map)
        for config in missings:
