...
from kairos import check_dev_mode
...
from kairos.logger.application_warning import ApplicationWarning
...
class StatusCommand:
    def _expire_old_application_warnings(self,  # type: KairosApplication
                                         ):
        now: float = time.time()
    ...
    def _format_application_warnings(self,  # type: KairosApplication
                                     ) -> str:
        lines: List[str] = []
    ...
    def status(self,  # type: KairosApplication
               live: bool = False):
    ...
    async def status_check_all(self,  # type: KairosApplication
                               notify_success=True,
                               live=False) -> bool:
