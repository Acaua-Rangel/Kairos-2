...
from kairos.client.settings import AllConnectorSettings, ConnectorSetting
...
class TradingPairFetcher:
    ...
    _tpf_logger: Optional[KairosLogger] = None
    ...
    def _get_client_config_map() -> "ClientConfigAdapter":
        ...
        client_config_map = KairosApplication.main_application().client_config_map
